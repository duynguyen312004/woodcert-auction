...
Chuyên gia kiểm định là actor phụ trách đánh giá sản phẩm và lập báo cáo thẩm định theo quy trình của hệ thống. Quản trị viên chịu trách nhiệm quản lý người dùng, năng lực tài khoản, kiểm định viên, danh mục, doanh thu, audit log và tranh chấp. Bên cạnh đó, các tiến trình tự động như auction scheduler, order payment scheduler và fulfillment scheduler hỗ trợ mở hoặc kết thúc phiên, xử lý đơn quá hạn thanh toán và tự hoàn tất giao nhận theo điều kiện cấu hình.
...
| Chuyên gia kiểm định (Appraiser) | Người dùng được cấp quyền để xử lý nghiệp vụ kiểm định sản phẩm. | Tiếp nhận yêu cầu kiểm định; đánh giá sản phẩm; lập báo cáo thẩm định; cấp hoặc chốt chứng thư theo quy trình hệ thống. |
...
| Thẩm định và chứng thư | Seller, Appraiser, Guest, Bidder/Buyer | Quản lý yêu cầu kiểm định, thao tác tiếp nhận của appraiser, báo cáo thẩm định và chứng thư sản phẩm. Chứng thư cung cấp cơ sở để người mua tra cứu thông tin trước khi tham gia đấu giá. |
