...
public enum ErrorCode {
    ...
    ACCOUNT_LOCKED(403, "Account is temporarily locked due to too many failed login attempts"),
    ...
    AUCTION_REGISTRATION_WITHDRAWN(409, "You cannot register again after withdrawing from this auction"),
    AUCTION_PARTICIPATION_NOT_FOUND(404, "You have not registered for this auction"),
    AUCTION_PARTICIPATION_ALREADY_WITHDRAWN(409, "You have already withdrawn from this auction"),
    AUCTION_PARTICIPATION_NOT_WITHDRAWABLE(409, "You can only withdraw while the auction is waiting and your deposit is frozen"),
    ...
    ORDER_SHIPMENT_DEADLINE_EXCEEDED(400, "Shipment deadline has been exceeded"),
